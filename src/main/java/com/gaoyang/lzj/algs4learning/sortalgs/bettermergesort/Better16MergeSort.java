 ...
 * @date 2019/5/18
 */
public class Better16MergeSort implements SortAlgo {
    @Override
    ...
    public static void main(String[] args) {
        ...
        sortCompareDouble(Algs4Consts.times, Algs4Consts.minLen, Algs4Consts.maxLen, Algs4Consts.maxDur, new Better16MergeSort());
    }
